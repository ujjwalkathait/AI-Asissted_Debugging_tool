...
//             debugOutput.innerHTML = `<pre>${result.fixedCode || "// No corrections found."}</pre>`;
...
//     // Add example code on first click (optional)
...
// 3) Load editor.main and create the editor
require(['vs/editor/editor.main'], function () {
    monaco.editor.create(document.getElementById('code-input'), {
    value: [
        '// type your code here',
        'function hello() {',
    ...
    language: 'javascript',
    theme: 'vs-dark',
    automaticLayout: true,    // auto‑resize editor on container change
    });
});
